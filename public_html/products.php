...
//   }
  $result = $conn->query("SELECT * FROM products ORDER BY added_on DESC");
?>
<!DOCTYPE html>
  ...
  <body>
   <?php if(!(isset($_SESSION["name"]))): ?>
    ...
    <div class="prodpage">
       ...
       <header><h2> All Products</h2></header>
       
     <div class='prodlist'> 
     <h2>Our Products</h2>
     <p>This is a list of all our products. Look through them and click on them to get more information
     about the products and there prices</p>
    <div class="card">
