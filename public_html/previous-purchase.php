...
<html lang="en">
  <head>
    ...
    <title>Previous Purchases- AmaExpress</title>
  </head>
  ...
  <body>
    ...
    <nav class="navbar">
      ...
      <ul class="navitems">
        ...
        <li><a class="active" href="previous-purchase.php">Previous Purchases</a></li>
    ...
    <div class="prevprodpage">
        
       <header><h2> Previously Purchased Products</h2></header>
